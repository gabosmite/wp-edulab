				...
				<div class="courses">
					<div class="owl-one owl-carousel">
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap" itemprop="image"><img src="<?php echo ASSETS ?>images/course-pic.jpg" alt="courses picture"></div>
			...
			<div class="container">
				<div class="event-wrap">
					<div class="img-wrap" itemprop="image">
						<img src="<?php echo ASSETS ?>images/events.jpg" alt="event images">
					</div>
					<div class="details">
						...
						<ul class="slides">
							<li class="img-wrap">
								<figure itemprop="image">
									<img src="<?php echo ASSETS ?>images/review-big-img.jpg" alt="Person Image">
				...
				<div class="three owl-carousel owl-theme">
					<div class="customer-item" itemscope itemtype="http://schema.org/Rating">
						<div class="border">
							<div class="customer">
								<figure>
									<img class="customer-img" src="<?php echo ASSETS ?>images/customer-img.jpg" alt="Person image">
									<figcaption>
				...
				<div class="owl-two owl-carousel">
					<div class="news-wrap" itemprop="event">
						<div class="news-img-wrap" itemprop="image">
							<img src="<?php echo ASSETS ?>images/latest-new-img.jpg" alt="Latest News Images">
						</div>
